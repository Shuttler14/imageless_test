class ProductSlider {
    constructor(sliderElement) {
        ...
        this.wrapper = this.slider.closest(".product-slider-wrapper");
        ...
        this.prevButton = this.wrapper.querySelector(".product-slider-prev") || null;
        this.nextButton = this.wrapper.querySelector(".product-slider-next") || null;
        this.pagination = this.wrapper.querySelector(".product-slider-pagination") || null;        
        this.initSwiper();
    }
    ...
    initSwiper() {
        ...
        this.swiper = new Swiper(this.slider, {
            ...
            breakpoints: {
                360: { slidesPerView: 1.4, spaceBetween: 14 },
...
function initAllSliders() {
    document.querySelectorAll(".js-product-slider").forEach((slider) => {
